...
package com.example.rpcfxcore.netty.client;
...
//        String requestJson = JSON.toJSONString(rpcRequest);
        ...
        byte[] serialize = rpcSerializer.serialize(rpcRequest);
        request.setLen(serialize.length);
        request.setContent(serialize);
        return request;
    }
